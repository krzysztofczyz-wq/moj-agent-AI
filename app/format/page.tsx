...
export default function FormatPage() {
  ...
  // Point to the /api/format endpoint using DefaultChatTransport
  ...
  const handleExport = () => {
    const text = messages.map(m => {
      const sender = m.role === 'user' ? 'User' : 'Formater (Agent)';
  ...
  return (
    <div className="chat-container">
      ...
      <header className="chat-header">
        <h1>📐 Formatowanie 📋</h1>
        <p className="chat-subheader">Agent odpowiada w tabeli, liście, porównaniu — na żądanie</p>
      </header>
      ...
      <form onSubmit={handleSubmit} className="chat-form">
        <input
          ...
          placeholder="Wpisz pojęcie lub komendę (np. /tabela...)..."
